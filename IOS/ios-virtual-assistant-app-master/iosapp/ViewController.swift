...
extension ViewController: MessageInputBarDelegate {
    ...
    func messageInputBar(_ inputBar: MessageInputBar, didPressSendButtonWith text: String) {
        ...
        if(cleanText.contains("itch") || cleanText.contains("Itch")) {
            httpRequestDemo().perfromRequest(urlSring: "https://e1e25fcb8f7f.ngrok.io/eyeInchy")
            print("http request successful")
        }
        
        if(cleanText.contains("sneeze") || cleanText.contains("Sneeze")) {
            httpRequestDemo().perfromRequest(urlSring: "https://e1e25fcb8f7f.ngrok.io/sneeze")
            print("http request successful")
        }
        
        if(cleanText.contains("shake") || cleanText.contains("Shake")) {
            httpRequestDemo().perfromRequest(urlSring: "https://e1e25fcb8f7f.ngrok.io/elbowBump")
            print("http request successful")
        }
        
        if (cleanText.contains("game") || cleanText.contains("Game")){
